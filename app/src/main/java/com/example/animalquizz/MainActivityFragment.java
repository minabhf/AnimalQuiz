...
import static com.example.animalquizz.MainActivity.GUESSES;
...
public class MainActivityFragment extends Fragment {
    ...
    private View.OnClickListener btnGuessListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            //when user quess the right answer
...
// geting animal image and names from assets
        try {
        ...
        int counter = 1;
        int numberOfAvailabeleAnimals = allAnimalsNamesList.size();

        while (counter <= NUMBER_OF_ANIMALS_INCLUDED_IN_QUIZ) {

            int randomIndex = secureRandomNumber.nextInt(numberOfAvailabeleAnimals);
...
//Here is max value for radius
    ...
    private void showNextAnimal() {
        ...
        String animalType = nextAnimalImageName.substring(0, nextAnimalImageName.indexOf("_"));
    ...
    public void modifyAnimalsGuessRows(SharedPreferences sharedPreferences) {
        ...
        final String NUMER_OF_GUESS_OPTIONS = sharedPreferences.getString(MainActivity.GUESSES, null);

        numberOfAnimalsGuessRows = Integer.parseInt(NUMER_OF_GUESS_OPTIONS) / 2;
    ...
    public void modifyBackgroundColor(SharedPreferences sharedPreferences) {
        ...
        String bachgroundColor = sharedPreferences.getString(MainActivity.QUIZ_BACKGROUND_COLOR, null);

        switch (bachgroundColor) {
